...
// Code generated by MockGen. DO NOT EDIT.
// Source: bootresource.go
//
// Generated by this command:
//
//      mockgen -source=bootresource.go
//

// Package mock_maasclient is a generated GoMock package.

// MockBootResources is a mock of BootResources interface.
type MockBootResources struct {
    ctrl     *gomock.Controller
    recorder *MockBootResourcesMockRecorder
}

// MockBootResourcesMockRecorder is the mock recorder for MockBootResources.
type MockBootResourcesMockRecorder struct {
    mock *MockBootResources
}

// NewMockBootResources creates a new mock instance.
func NewMockBootResources(ctrl *gomock.Controller) *MockBootResources {
    mock := &MockBootResources{ctrl: ctrl}
    mock.recorder = &MockBootResourcesMockRecorder{mock}
    return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBootResources) EXPECT() *MockBootResourcesMockRecorder {
    return m.recorder
}

// BootResource mocks base method.
func (m *MockBootResources) BootResource(id int) maasclient.BootResource {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "BootResource", id)
    ret0, _ := ret[0].(maasclient.BootResource)
    return ret0
}

// BootResource indicates an expected call of BootResource.
func (mr *MockBootResourcesMockRecorder) BootResource(id any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BootResource", reflect.TypeOf((*MockBootResources)(nil).BootResource), id)
}

// Builder mocks base method.
func (m *MockBootResources) Builder(name, architecture, hash, filePath string, size int) maasclient.BootResourceBuilder {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "Builder", name, architecture, hash, filePath, size)
    ret0, _ := ret[0].(maasclient.BootResourceBuilder)
    return ret0
}

// Builder indicates an expected call of Builder.
func (mr *MockBootResourcesMockRecorder) Builder(name, architecture, hash, filePath, size any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Builder", reflect.TypeOf((*MockBootResources)(nil).Builder), name, architecture, hash, filePath, size)
}

// List mocks base method.
func (m *MockBootResources) List(ctx context.Context, params maasclient.Params) ([]maasclient.BootResource, error) {
    m.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *MockBootResourcesMockRecorder) List(ctx, params any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockBootResources)(nil).List), ctx, params)
}

// MockBootResource is a mock of BootResource interface.
type MockBootResource struct {
    ctrl     *gomock.Controller
    recorder *MockBootResourceMockRecorder
}

// MockBootResourceMockRecorder is the mock recorder for MockBootResource.
type MockBootResourceMockRecorder struct {
    mock *MockBootResource
}

// NewMockBootResource creates a new mock instance.
func NewMockBootResource(ctrl *gomock.Controller) *MockBootResource {
    mock := &MockBootResource{ctrl: ctrl}
    mock.recorder = &MockBootResourceMockRecorder{mock}
    return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBootResource) EXPECT() *MockBootResourceMockRecorder {
    return m.recorder
}

// Architecture mocks base method.
func (m *MockBootResource) Architecture() string {
    m.ctrl.T.Helper()
...
func (mr *MockBootResourceMockRecorder) Architecture() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Architecture", reflect.TypeOf((*MockBootResource)(nil).Architecture))
}

// Delete mocks base method.
func (m *MockBootResource) Delete(ctx context.Context) error {
    m.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockBootResourceMockRecorder) Delete(ctx any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockBootResource)(nil).Delete), ctx)
}

// Get mocks base method.
func (m *MockBootResource) Get(ctx context.Context) (maasclient.BootResource, error) {
    m.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockBootResourceMockRecorder) Get(ctx any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockBootResource)(nil).Get), ctx)
}

// ID mocks base method.
func (m *MockBootResource) ID() int {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "ID")
    ret0, _ := ret[0].(int)
    return ret0
...
// ID indicates an expected call of ID.
func (mr *MockBootResourceMockRecorder) ID() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ID", reflect.TypeOf((*MockBootResource)(nil).ID))
}

// Name mocks base method.
func (m *MockBootResource) Name() string {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "Name")
    ret0, _ := ret[0].(string)
    return ret0
...
// Name indicates an expected call of Name.
func (mr *MockBootResourceMockRecorder) Name() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Name", reflect.TypeOf((*MockBootResource)(nil).Name))
}

// Sets mocks base method.
func (m *MockBootResource) Sets() map[string]maasclient.Set {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "Sets")
    ret0, _ := ret[0].(map[string]maasclient.Set)
    return ret0
}

// Sets indicates an expected call of Sets.
func (mr *MockBootResourceMockRecorder) Sets() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Sets", reflect.TypeOf((*MockBootResource)(nil).Sets))
}

// SubArches mocks base method.
func (m *MockBootResource) SubArches() string {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "SubArches")
    ret0, _ := ret[0].(string)
    return ret0
}

// SubArches indicates an expected call of SubArches.
func (mr *MockBootResourceMockRecorder) SubArches() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubArches", reflect.TypeOf((*MockBootResource)(nil).SubArches))
}

// Title mocks base method.
func (m *MockBootResource) Title() string {
    m.ctrl.T.Helper()
...
func (mr *MockBootResourceMockRecorder) Title() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Title", reflect.TypeOf((*MockBootResource)(nil).Title))
}

// Type mocks base method.
func (m *MockBootResource) Type() string {
    m.ctrl.T.Helper()
...
func (mr *MockBootResourceMockRecorder) Type() *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Type", reflect.TypeOf((*MockBootResource)(nil).Type))
}

// Upload mocks base method.
func (m *MockBootResource) Upload(ctx context.Context) error {
    m.ctrl.T.Helper()
...
func (mr *MockBootResourceMockRecorder) Upload(ctx any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upload", reflect.TypeOf((*MockBootResource)(nil).Upload), ctx)
}

// MockBootResourceBuilder is a mock of BootResourceBuilder interface.
type MockBootResourceBuilder struct {
    ctrl     *gomock.Controller
    recorder *MockBootResourceBuilderMockRecorder
}

// MockBootResourceBuilderMockRecorder is the mock recorder for MockBootResourceBuilder.
type MockBootResourceBuilderMockRecorder struct {
    mock *MockBootResourceBuilder
}

// NewMockBootResourceBuilder creates a new mock instance.
func NewMockBootResourceBuilder(ctrl *gomock.Controller) *MockBootResourceBuilder {
    mock := &MockBootResourceBuilder{ctrl: ctrl}
    mock.recorder = &MockBootResourceBuilderMockRecorder{mock}
    return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBootResourceBuilder) EXPECT() *MockBootResourceBuilderMockRecorder {
    return m.recorder
}

// Create mocks base method.
func (m *MockBootResourceBuilder) Create(ctx context.Context) (maasclient.BootResource, error) {
    m.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockBootResourceBuilderMockRecorder) Create(ctx any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockBootResourceBuilder)(nil).Create), ctx)
}

// WithBaseImage mocks base method.
func (m *MockBootResourceBuilder) WithBaseImage(baseImage string) maasclient.BootResourceBuilder {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "WithBaseImage", baseImage)
    ret0, _ := ret[0].(maasclient.BootResourceBuilder)
    return ret0
}

// WithBaseImage indicates an expected call of WithBaseImage.
func (mr *MockBootResourceBuilderMockRecorder) WithBaseImage(baseImage any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithBaseImage", reflect.TypeOf((*MockBootResourceBuilder)(nil).WithBaseImage), baseImage)
}

// WithFileType mocks base method.
func (m *MockBootResourceBuilder) WithFileType(fileType string) maasclient.BootResourceBuilder {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "WithFileType", fileType)
    ret0, _ := ret[0].(maasclient.BootResourceBuilder)
    return ret0
}

// WithFileType indicates an expected call of WithFileType.
func (mr *MockBootResourceBuilderMockRecorder) WithFileType(fileType any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithFileType", reflect.TypeOf((*MockBootResourceBuilder)(nil).WithFileType), fileType)
}

// WithTitle mocks base method.
func (m *MockBootResourceBuilder) WithTitle(title string) maasclient.BootResourceBuilder {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "WithTitle", title)
    ret0, _ := ret[0].(maasclient.BootResourceBuilder)
    return ret0
}

// WithTitle indicates an expected call of WithTitle.
func (mr *MockBootResourceBuilderMockRecorder) WithTitle(title any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithTitle", reflect.TypeOf((*MockBootResourceBuilder)(nil).WithTitle), title)
}

// MockBootResourceUploader is a mock of BootResourceUploader interface.
type MockBootResourceUploader struct {
    ctrl     *gomock.Controller
    recorder *MockBootResourceUploaderMockRecorder
}

// MockBootResourceUploaderMockRecorder is the mock recorder for MockBootResourceUploader.
type MockBootResourceUploaderMockRecorder struct {
    mock *MockBootResourceUploader
}

// NewMockBootResourceUploader creates a new mock instance.
func NewMockBootResourceUploader(ctrl *gomock.Controller) *MockBootResourceUploader {
    mock := &MockBootResourceUploader{ctrl: ctrl}
    mock.recorder = &MockBootResourceUploaderMockRecorder{mock}
    return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBootResourceUploader) EXPECT() *MockBootResourceUploaderMockRecorder {
    return m.recorder
}

// Upload mocks base method.
func (m *MockBootResourceUploader) Upload(ctx context.Context) error {
    m.ctrl.T.Helper()
    ret := m.ctrl.Call(m, "Upload", ctx)
    ret0, _ := ret[0].(error)
    return ret0
...
// Upload indicates an expected call of Upload.
func (mr *MockBootResourceUploaderMockRecorder) Upload(ctx any) *gomock.Call {
    mr.mock.ctrl.T.Helper()
    return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upload", reflect.TypeOf((*MockBootResourceUploader)(nil).Upload), ctx)
}
