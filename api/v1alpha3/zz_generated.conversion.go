...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MaasMachineSpec)(nil), (*v1alpha4.MaasMachineSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_MaasMachineSpec_To_v1alpha4_MaasMachineSpec(a.(*MaasMachineSpec), b.(*v1alpha4.MaasMachineSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha4.MaasMachineSpec)(nil), (*MaasMachineSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha3_MaasMachineList_To_v1alpha4_MaasMachineList(in *MaasMachineList, out *v1alpha4.MaasMachineList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1alpha4.MaasMachine)(unsafe.Pointer(&in.Items))
	return nil
}
...
func autoConvert_v1alpha3_MaasMachineSpec_To_v1alpha4_MaasMachineSpec(in *MaasMachineSpec, out *v1alpha4.MaasMachineSpec, s conversion.Scope) error {
	...
	out.MinMemory = (*int)(unsafe.Pointer(in.MinMemory))
	out.Image = in.Image
	return nil
}

// Convert_v1alpha3_MaasMachineSpec_To_v1alpha4_MaasMachineSpec is an autogenerated conversion function.
func Convert_v1alpha3_MaasMachineSpec_To_v1alpha4_MaasMachineSpec(in *MaasMachineSpec, out *v1alpha4.MaasMachineSpec, s conversion.Scope) error {
	return autoConvert_v1alpha3_MaasMachineSpec_To_v1alpha4_MaasMachineSpec(in, out, s)
}
...
// Convert_v1alpha4_MaasMachineSpec_To_v1alpha3_MaasMachineSpec is an autogenerated conversion function.
func Convert_v1alpha4_MaasMachineSpec_To_v1alpha3_MaasMachineSpec(in *v1alpha4.MaasMachineSpec, out *MaasMachineSpec, s conversion.Scope) error {
	return autoConvert_v1alpha4_MaasMachineSpec_To_v1alpha3_MaasMachineSpec(in, out, s)
}
...
func autoConvert_v1alpha3_MaasMachineTemplateList_To_v1alpha4_MaasMachineTemplateList(in *MaasMachineTemplateList, out *v1alpha4.MaasMachineTemplateList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1alpha4.MaasMachineTemplate)(unsafe.Pointer(&in.Items))
	return nil
}
