...
func (r *MaasMachine) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	maasmachinelog.Info("validate create", "name", r.Name)
	return nil, nil
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (r *MaasMachine) ValidateDelete(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	maasmachinelog.Info("validate delete", "name", r.Name)
	return nil, nil
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (r *MaasMachine) ValidateUpdate(ctx context.Context, old runtime.Object, new runtime.Object) (admission.Warnings, error) {
