...
|--------------|-------------------------------------------------------------------------------------------------|
| \>= 3.5.10   | ✅ Supported                                                                                    |
| \>= 3.6.2    | ⚠️ Supported with known issues (bugs [2132663](https://bugs.launchpad.net/maas/+bug/2132663) and [2134059](https://bugs.launchpad.net/maas/+bug/2134059) may not be fixed) |
| \>= 3.7.1    | ✅ Supported                                                                                    |
